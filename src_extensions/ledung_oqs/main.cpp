...
extern "C"
{
    PHPCPP_EXPORT void* get_module()
    {
        ...
        signature.method<&LDSignature::__construct>("__construct", {Php::ByVal("algorithm", Php::Type::String, false)});
        ...
        signature.method<&LDSignature::verify>("verify",
                                               {Php::ByVal("filename", Php::Type::String), Php::ByVal("signature_filename", Php::Type::String)});
        ...
        signature.method<&LDSignature::load_public_key_from_string>("load_public_key_from_string", {Php::ByVal("b64_key", Php::Type::String)});

        signature.method<&LDSignature::load_public_key_from_file>("load_public_key_from_file",
                                                                  {Php::ByVal("public_key_filename", Php::Type::String)});

        signature.method<&LDSignature::load_secret_key_from_string>("load_secret_key_from_string", {Php::ByVal("b64_key", Php::Type::String)});

        signature.method<&LDSignature::load_secret_key_from_file>("load_secret_key_from_file",
